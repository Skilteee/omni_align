...
def main():
    ...
    if args.act_scales is None:
        # args.act_scales = f'/home/qitao/ptq_align/act_scales/{args.net}.pt'
        args.act_scales = f'/home/Qitao/project/ZO_quant_new/act_scales/{args.net}.pt'
        act_scales = torch.load(args.act_scales)
    if args.act_shifts is None and 'opt' in args.net.lower():
        # args.act_shifts = f'/home/qitao/ptq_align/act_shifts/{args.net}.pt'
        args.act_shifts = f'/home/Qitao/project/ZO_quant_new/act_shifts/{args.net}.pt'
    ...
    # '/home/Qitao/project/ZO_quant_new/cache/dataloader_opt_wikitext2_1280_128_4.cache'
    # cache_dataloader = "/home/Qitao/project/ZO_quant_new/cache/dataloader_opt_wikitext2_1280_2048_4.cache"
    # cache_dataloader = f'/home/Qitao/project/ZO_quant_new/cache/dataloader_{args.model_family}_{args.calib_dataset}_{args.nsamples}.cache'
    ...
    #     logger.info(f"save calibration at {cache_dataloader}")
...
if __name__ == "__main__":
    # CUDA_VISIBLE_DEVICES=2 python main.py --model meta-llama/Llama-2-7b-chat-hf --model_resume /home/Qitao/project/ptq_align/llama2-7b-alpaca-harmful005 --eval_ppl --output_dir ./log/Llama-2-7b-chat-alpaca-harmful005-w8a8 --wbits 8 --abits 8 --lwc --let --let_lr 1e-3 --epochs 10
    print(sys.argv)
    main()
